...
def sort_and_print_restaurants(ratings):
    # create sorted_values to sort restaurants by rating then sort restaurants alphabetically    
    sorted_values = sorted(ratings.iteritems(), key = operator.itemgetter(1,0))
